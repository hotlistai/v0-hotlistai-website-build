...
export async function generateMetadata({
  ...
  return {
    ...
    authors: [{ name: post.author, url: "https://hotlistengine.com/company" }],
    openGraph: {
...
export default async function BlogPostPage({
  ...
  const jsonLd = {
    ...
    "@type": "BlogPosting",
    "@id": `https://hotlistengine.com/blog/${post.slug}`,
    headline: post.title,
    description: post.description,
    ...
    author: {
      ...
      url: "https://hotlistengine.com/company",
      worksFor: {
        "@type": "Organization",
        name: "Hotlist",
      },
    ...
    image: "https://hotlistengine.com/og-image.jpg",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://hotlistengine.com",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Blog",
          item: "https://hotlistengine.com/blog",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: post.category,
          item: `https://hotlistengine.com/blog/category/${slugifyCategory(post.category)}`,
        },
        {
          "@type": "ListItem",
          position: 4,
          name: post.title,
          item: `https://hotlistengine.com/blog/${post.slug}`,
        },
      ],
    },
    speakable: {
