...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [...post.tags, "Hotlist", "real estate CRM follow-up"],
    authors: [{ name: post.author, url: "https://www.hotlistengine.com/company" }],
    openGraph: {
      title: `${post.title} | Hotlist Blog`,
      description: post.description,
...
export default async function BlogPostPage({
  ...
  const jsonLd = {
    ...
    "@type": "BlogPosting",
    "@id": `https://www.hotlistengine.com/blog/${post.slug}`,
    headline: post.title,
    description: post.description,
    ...
    author: {
      ...
      url: "https://www.hotlistengine.com/company",
      worksFor: {
        "@type": "Organization",
        name: "Hotlist",
      },
    ...
    image: "https://www.hotlistengine.com/og-image.jpg",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://www.hotlistengine.com",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Blog",
          item: "https://www.hotlistengine.com/blog",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: post.category,
          item: `https://www.hotlistengine.com/blog/category/${slugifyCategory(post.category)}`,
        },
        {
          "@type": "ListItem",
          position: 4,
          name: post.title,
          item: `https://www.hotlistengine.com/blog/${post.slug}`,
        },
      ],
    },
    speakable: {
