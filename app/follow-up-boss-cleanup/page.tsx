        ...
        <section className="py-20 px-4 md:px-6 border-b border-border/40">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-border/40 bg-muted/20 p-6">
              ...
              <h2 className="text-3xl font-serif mb-4">Reactivation opportunities</h2>
              <p className="text-muted-foreground leading-relaxed">
                We separate old leads into practical recovery segments so your team knows who should get attention now
                and who belongs in longer nurture.
              </p>
            </div>
            <div className="rounded-2xl border border-border/40 bg-muted/20 p-6">
              <Tags className="h-7 w-7 mb-6 text-muted-foreground" strokeWidth={1.5} />
              <h2 className="text-3xl font-serif mb-4">Cleaner operating rules</h2>
              <p className="text-muted-foreground leading-relaxed">
                Cleanup is not cosmetic. It gives agents clearer lists, cleaner next actions, and less ambiguity about
                what matters today.
              </p>
            </div>
            <div className="rounded-2xl border border-border/40 bg-muted/20 p-6">
