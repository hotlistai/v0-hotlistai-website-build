  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0A0A0A] text-[#E5E5E5]">
      ...
      <main className="flex-1">
        <section className="py-20 md:py-32 px-4 md:px-6" aria-labelledby="dev-heading">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <h1 id="dev-heading" className="text-4xl sm:text-5xl md:text-6xl font-serif tracking-tight leading-[1.1]">The Foundry</h1>
