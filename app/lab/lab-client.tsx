  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <article>
          {/* Hero Section */}
          <section className="py-24 md:py-32 px-4 md:px-6 border-b border-border/40" aria-labelledby="lab-hero-heading">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 id="lab-hero-heading" className="text-5xl md:text-6xl lg:text-7xl font-serif tracking-tight mb-6 leading-tight">
          ...
          {/* Products Grid */}
          <section className="py-24 px-4 md:px-6" aria-labelledby="products-grid-heading">
            <h2 id="products-grid-heading" className="sr-only">AI Software Products</h2>
          ...
          {/* CTA Section */}
          <section className="py-20 md:py-32 px-4 md:px-6 border-t border-border/40 bg-muted/20" aria-labelledby="lab-cta-heading">
            <div className="max-w-3xl mx-auto text-center">
              <h2 id="lab-cta-heading" className="text-3xl md:text-4xl font-serif tracking-tight mb-6">Ready to Deploy?</h2>
