...
export const alt = "Hotlist Labs - Press & Media"
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 80px" }}>
        <p style={{ fontSize: 24, color: "#888888", margin: 0, marginBottom: 20 }}>Hotlist Labs</p>
        <h1
        ...
        <p style={{ fontSize: 28, color: "#666666", textAlign: "center", margin: 0, maxWidth: 800 }}>
          Resources for journalists and media inquiries.
        </p>
      </div>
