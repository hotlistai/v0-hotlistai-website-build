      ...
      <main className="flex-1">
        <section className="py-20 md:py-32 px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight">Press</h1>
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Our products—including Estate Mogul, Titanium, Hotlist Studio, and LyftEmail—give founders and
