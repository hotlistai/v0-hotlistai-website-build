...
export default function FunnelsPageClient() {
  useScrollAnimations()
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <article>
          {/* Hero Section */}
          <section className="py-24 md:py-32 px-4 md:px-6 border-b border-border/40" aria-labelledby="funnels-hero-heading">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 id="funnels-hero-heading" className="text-5xl md:text-6xl lg:text-7xl font-serif tracking-tight mb-6 leading-tight">
                Hotlist Funnels
              </h1>
          ...
          {/* Key Features */}
          <section className="py-24 px-4 md:px-6 bg-muted/20 border-b border-border/40" aria-labelledby="stats-heading">
          ...
          {/* Industry Solutions */}
          <section className="py-24 px-4 md:px-6" aria-labelledby="industries-heading">
            <div className="max-w-7xl mx-auto">
              <header className="mb-12 text-center">
                <h2 id="industries-heading" className="font-serif text-4xl md:text-5xl mb-4">Industry Chameleon</h2>
          ...
          {/* Pricing Section */}
          <section className="py-24 px-4 md:px-6 border-t border-border/40 bg-muted/20" aria-labelledby="pricing-heading">
            <div className="max-w-5xl mx-auto">
              <header className="text-center mb-12">
                <h2 id="pricing-heading" className="font-serif text-4xl md:text-5xl mb-4">Simple Pricing</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="p-8 bg-foreground text-background border border-foreground rounded-xl relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-green-600 text-background text-xs font-semibold rounded-full">
                    Popular
                  </div>
          ...
          {/* CTA Section */}
          <section className="py-20 md:py-32 px-4 md:px-6 border-t border-border/40" aria-labelledby="funnels-cta-heading">
            <div className="max-w-3xl mx-auto text-center">
              <h2 id="funnels-cta-heading" className="text-3xl md:text-4xl font-serif tracking-tight mb-6">Ready to Ignite?</h2>
